<section class="{{$systemBG}} text-white w-screen h-full ml-0 md:ml-56 md:mt-16">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
      <div class="flex justify-start w-full">
        <div class="tabs">
          <a href="/system/announcement" class="tab tab-lg tab-lifted">Announcement</a>
          <a href="/system/announcement/messages" class="tab tab-lg tab-lifted tab-active">Messages</a> 
        </div>
      </div>  
	<div class="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-base-100 text-neutral">
					...
					<div class="flex flex-col justify-between w-full pb-4">
						<div class="flex justify-between w-full pb-2 space-x-2">
							...
							<div class="text-right">
								...
								<p class="text-sm line-through text-gray-600">150€</p>
							</div>
						</div>
						<div class="flex text-sm divide-x">
							<button type="button" class="flex items-center px-2 py-1 pl-0 space-x-1">
					...
					<div class="flex flex-col justify-between w-full pb-4">
						<div class="flex justify-between w-full pb-2 space-x-2">
							...
							<div class="text-right">
								...
								<p class="text-sm line-through text-gray-600">15.99€</p>
							</div>
						</div>
						<div class="flex text-sm divide-x">
							<button type="button" class="flex items-center px-2 py-1 pl-0 space-x-1">
